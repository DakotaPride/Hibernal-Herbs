...
public class ItemRegistry {
    ...
    public static Item GROUND_HERBS = new Item(new Item.Settings());

    // Must be registered individually of the respective mod loader
    // public static Item HERBAL_GRIMOIRE = new HerbalGrimoireItem(new Item.Settings().maxCount(1));
    // public static Item SINGED_GRIMOIRE = new HerbalGrimoireItem(new Item.Settings().maxCount(1));

    public static Item SILIPTIUM_PETAL = new Item(new Item.Settings().maxCount(16));
    public static Item LUMBINETRIK_PETAL = new Item(new Item.Settings().maxCount(16));

    public static Item RING = new Item(new Item.Settings()
            .maxCount(1));
    public static Item GLUTTONOUS_RING = new GluttonousRingItem(new Item.Settings()
            .maxCount(1));
    public static Item ADV_GLUTTONOUS_RING = new AdvancedGluttonousRingItem(new Item.Settings()
            .maxCount(1));

    public static Item CRACKED_SIGIL = new Item(new Item.Settings()
            );
    public static Item SIGIL = new HerbalSigilItem(new Item.Settings()
            );

    public static Item SIGIL_PRIDE = new HerbalSigilItem(new Item.Settings()
            .maxCount(1));
    public static Item SIGIL_SLOTH = new HerbalSigilItem(new Item.Settings()
            .maxCount(1));
    public static Item SIGIL_LUST = new HerbalSigilItem(new Item.Settings()
            .maxCount(1));
    public static Item SIGIL_GLUTTONY = new HerbalSigilItem(new Item.Settings()
            .maxCount(1));
    public static Item SIGIL_WRATH = new HerbalSigilItem(new Item.Settings()
            .maxCount(1));
    public static Item SIGIL_GREED = new HerbalSigilItem(new Item.Settings()
            .maxCount(1));
    public static Item SIGIL_ENVY = new HerbalSigilItem(new Item.Settings()
            .maxCount(1));

    public static Item SIGIL_CONFIGURATION = new HerbalSigilItem(new Item.Settings()
            .maxCount(1));
    public static Item SIGIL_CONFIGURATION_ADVANCED = new HerbalSigilItem(new Item.Settings()
            .maxCount(1));
    public static Item SIGIL_MASTERY = new HerbalSigilItem(new Item.Settings()
            .maxCount(1));
    public static Item SIGIL_MASTERY_ADVANCED = new HerbalSigilItem(new Item.Settings()
            .maxCount(1));

    public static Item POUNDED_ROSEMARY = new Item(new Item.Settings().food(FoodComponentRegistry.POUNDED_HERB));
    public static Item POUNDED_THYME = new Item(new Item.Settings().food(FoodComponentRegistry.POUNDED_HERB));
    public static Item POUNDED_TARRAGON = new Item(new Item.Settings().food(FoodComponentRegistry.POUNDED_HERB));
    public static Item POUNDED_CHAMOMILE = new Item(new Item.Settings().food(FoodComponentRegistry.POUNDED_HERB));
    public static Item POUNDED_CHIVES = new Item(new Item.Settings().food(FoodComponentRegistry.POUNDED_HERB));
    public static Item POUNDED_VERBENA = new Item(new Item.Settings().food(FoodComponentRegistry.POUNDED_HERB));
    public static Item POUNDED_SORREL = new Item(new Item.Settings().food(FoodComponentRegistry.POUNDED_HERB));
    public static Item POUNDED_MARJORAM = new Item(new Item.Settings().food(FoodComponentRegistry.POUNDED_HERB));
    public static Item POUNDED_CHERVIL = new Item(new Item.Settings().food(FoodComponentRegistry.POUNDED_HERB));
    public static Item POUNDED_FENNSEL = new Item(new Item.Settings().food(FoodComponentRegistry.POUNDED_HERB));
    public static Item POUNDED_CEILLIS = new Item(new Item.Settings().food(FoodComponentRegistry.POUNDED_HERB));
    public static Item POUNDED_PUNUEL = new Item(new Item.Settings().food(FoodComponentRegistry.POUNDED_HERB));
    public static Item POUNDED_ESSITTE = new Item(new Item.Settings().food(FoodComponentRegistry.POUNDED_HERB));

    // Resource Dependant (Pounded) Herbs

    public static Item POUNDED_THYOCIELLE = new Item(new Item.Settings().food(FoodComponentRegistry.ARTIFICIAL_HERB));
    public static Item POUNDED_FENNKYSTRAL = new Item(new Item.Settings().food(FoodComponentRegistry.ARTIFICIAL_HERB));

    // Spring (Pounded) Herb(s)

    public static Item POUNDED_CALENDULA = new Item(new Item.Settings().food(FoodComponentRegistry.POUNDED_HERB));

    public static Item POUNDED_SAGE = new Item(new Item.Settings().food(FoodComponentRegistry.POUNDED_HERB));

    public static Item DRIED_CALENDULA = new Item(new Item.Settings().food(FoodComponentRegistry.DRIED_HERB));
    public static Item DRIED_ROSEMARY = new Item(new Item.Settings().food(FoodComponentRegistry.DRIED_HERB));
    public static Item DRIED_THYME = new Item(new Item.Settings().food(FoodComponentRegistry.DRIED_HERB));
    public static Item DRIED_TARRAGON = new Item(new Item.Settings().food(FoodComponentRegistry.DRIED_HERB));
    public static Item DRIED_CHAMOMILE = new Item(new Item.Settings().food(FoodComponentRegistry.DRIED_HERB));
    public static Item DRIED_CHIVES = new Item(new Item.Settings().food(FoodComponentRegistry.DRIED_HERB));
    public static Item DRIED_VERBENA = new Item(new Item.Settings().food(FoodComponentRegistry.DRIED_HERB));
    public static Item DRIED_SORREL = new Item(new Item.Settings().food(FoodComponentRegistry.DRIED_HERB));
    public static Item DRIED_MARJORAM = new Item(new Item.Settings().food(FoodComponentRegistry.DRIED_HERB));
    public static Item DRIED_CHERVIL = new Item(new Item.Settings().food(FoodComponentRegistry.DRIED_HERB));
    public static Item DRIED_FENNSEL = new Item(new Item.Settings().food(FoodComponentRegistry.DRIED_HERB));
    public static Item DRIED_CEILLIS = new Item(new Item.Settings().food(FoodComponentRegistry.DRIED_HERB));
    public static Item DRIED_PUNUEL = new Item(new Item.Settings().food(FoodComponentRegistry.DRIED_HERB));
    public static Item DRIED_ESSITTE = new Item(new Item.Settings().food(FoodComponentRegistry.DRIED_HERB));
    public static Item DRIED_THYOCIELLE = new Item(new Item.Settings().food(FoodComponentRegistry.DRIED_HERB));
    ...
    public static HerbBlendItem REGENERATION_SLOWNESS_BLEND = new HerbBlendItem(new Item.Settings().food(FoodComponentRegistry.CONFLICTING_BLEND)
            .maxCount(1));
    public static HerbBlendItem REGENERATION_SPEED_WEAKNESS_BLEND = new HerbBlendItem(new Item.Settings().food(FoodComponentRegistry.ALTERNATIVE_BLEND)
            .maxCount(1));

    public static HerbFertilizerItem HERB_FERTILIZER = new HerbFertilizerItem(new Item.Settings());

    public static HerbFertilizerItem HERB_FERTILIZER_OAK = new HerbFertilizerItem(new Item.Settings());
    public static HerbFertilizerItem HERB_FERTILIZER_DARK_OAK = new HerbFertilizerItem(new Item.Settings());
    public static HerbFertilizerItem HERB_FERTILIZER_BIRCH = new HerbFertilizerItem(new Item.Settings());
    public static HerbFertilizerItem HERB_FERTILIZER_JUNGLE = new HerbFertilizerItem(new Item.Settings());
    public static HerbFertilizerItem HERB_FERTILIZER_ACACIA = new HerbFertilizerItem(new Item.Settings());
    public static HerbFertilizerItem HERB_FERTILIZER_SPRUCE = new HerbFertilizerItem(new Item.Settings());
    public static HerbFertilizerItem HERB_FERTILIZER_MANGROVE = new HerbFertilizerItem(new Item.Settings());
    public static HerbFertilizerItem HERB_FERTILIZER_CHERRY = new HerbFertilizerItem(new Item.Settings());
    public static HerbFertilizerItem HERB_FERTILIZER_CRIMSON = new HerbFertilizerItem(new Item.Settings());
    public static HerbFertilizerItem HERB_FERTILIZER_WARPED = new HerbFertilizerItem(new Item.Settings());

    public static HerbFertilizerItem HERB_FERTILIZER_MYQUESTE = new HerbFertilizerItem(new Item.Settings());

    public static HerbHumusItem HERB_HUMUS = new HerbHumusItem(new Item.Settings());

    public static HerbHumusItem HERB_HUMUS_OAK = new HerbHumusItem(new Item.Settings());
    public static HerbHumusItem HERB_HUMUS_DARK_OAK = new HerbHumusItem(new Item.Settings());
    public static HerbHumusItem HERB_HUMUS_BIRCH = new HerbHumusItem(new Item.Settings());
    public static HerbHumusItem HERB_HUMUS_JUNGLE = new HerbHumusItem(new Item.Settings());
    public static HerbHumusItem HERB_HUMUS_ACACIA = new HerbHumusItem(new Item.Settings());
    public static HerbHumusItem HERB_HUMUS_SPRUCE = new HerbHumusItem(new Item.Settings());
    public static HerbHumusItem HERB_HUMUS_MANGROVE = new HerbHumusItem(new Item.Settings());
    public static HerbHumusItem HERB_HUMUS_CHERRY = new HerbHumusItem(new Item.Settings());
    public static HerbHumusItem HERB_HUMUS_CRIMSON = new HerbHumusItem(new Item.Settings());
    public static HerbHumusItem HERB_HUMUS_WARPED = new HerbHumusItem(new Item.Settings());
    ...
    public static AbstractPouchItem SCRATCHED_POUCH = new AbstractPouchItem(new Item.Settings().maxCount(1), 64);
    public static AbstractCanisterItem IRON_CANISTER = new AbstractCanisterItem(new Item.Settings().maxCount(1), 128);

    public static AbstractPouchItem STITCHED_POUCH = new AbstractPouchItem(new Item.Settings().maxCount(1), 192);
    public static AbstractCanisterItem AMETHYST_CANISTER = new AbstractCanisterItem(new Item.Settings().maxCount(1), 256);

    public static AbstractPouchItem PROPER_POUCH = new AbstractPouchItem(new Item.Settings().maxCount(1), 256);
    public static AbstractCanisterItem DIAMOND_CANISTER = new AbstractCanisterItem(new Item.Settings().maxCount(1), 384);

    // Legacy

    public static AbstractPouchItem POUCH = new AbstractPouchItem(new Item.Settings().maxCount(1), 256);
    public static AbstractCanisterItem CANISTER = new AbstractCanisterItem(new Item.Settings().maxCount(1), 384);
