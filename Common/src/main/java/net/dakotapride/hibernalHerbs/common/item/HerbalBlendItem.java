...
//            HerbalBlendTypes.applyFromConsumption(stack, player, HerbalBlendTypes.REGENERATION_SPEED_WEAKNESS);
    ...
    public @NotNull InteractionResult interactLivingEntity(@NotNull ItemStack stack, Player player, @NotNull LivingEntity livingEntity, @NotNull InteractionHand hand) {
        ...
        HerbalBlendTypes.applyFromInteraction(stack, livingEntity, HerbalBlendTypes.REGENERATION);
        HerbalBlendTypes.applyFromInteraction(stack, livingEntity, HerbalBlendTypes.POISON);
        HerbalBlendTypes.applyFromInteraction(stack, livingEntity, HerbalBlendTypes.SLOWNESS);
        HerbalBlendTypes.applyFromInteraction(stack, livingEntity, HerbalBlendTypes.MINING_FATIGUE);
        HerbalBlendTypes.applyFromInteraction(stack, livingEntity, HerbalBlendTypes.HASTE);
        HerbalBlendTypes.applyFromInteraction(stack, livingEntity, HerbalBlendTypes.SPEED);
        HerbalBlendTypes.applyFromInteraction(stack, livingEntity, HerbalBlendTypes.FIRE);
        HerbalBlendTypes.applyFromInteraction(stack, livingEntity, HerbalBlendTypes.WITHER);
        HerbalBlendTypes.applyFromInteraction(stack, livingEntity, HerbalBlendTypes.NIGHT_VISION);
        HerbalBlendTypes.applyFromInteraction(stack, livingEntity, HerbalBlendTypes.WEAKNESS);
        HerbalBlendTypes.applyFromInteraction(stack, livingEntity, HerbalBlendTypes.BLINDNESS);
    ...
    public void appendHoverText(ItemStack stack, @Nullable TooltipContext level, @NotNull List<Component> tooltip, @NotNull TooltipFlag tooltipFlag) {
        if (!Screen.hasShiftDown()) {
            ...
            if (!stack.is(Tags.Items.ARTIFICIAL_BLENDS.getTag())) {
                ...
                HerbalBlendTypes.getExceptionTooltip(stack, tooltip);
