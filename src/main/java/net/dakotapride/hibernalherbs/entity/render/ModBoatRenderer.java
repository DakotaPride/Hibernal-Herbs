package net.dakotapride.hibernalherbs.entity.render;
...
// Boat code credited to Ecologics Devs
...
public class ModBoatRenderer<T extends ModBoatEntity> extends EntityRenderer<T> {
    ...
    private ListModel<Boat> createBoatModel(EntityRendererProvider.Context context, ModBoatEntity.Type type, boolean hasChest) {
        ModelLayerLocation modelLayerLocation = hasChest ?
                new ModelLayerLocation(HibernalHerbsMod.asResource(type.getChestModelLocation()), "main")
                : new ModelLayerLocation(HibernalHerbsMod.asResource(type.getModelLocation()), "main");
