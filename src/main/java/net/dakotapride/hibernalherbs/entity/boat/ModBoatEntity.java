package net.dakotapride.hibernalherbs.entity.boat;
...
public class ModBoatEntity extends Boat {
    ...
    public enum Type {
        MYQUESTE("myqueste", () -> WoodTypes.MYQUESTE.getBoatItem(), () -> WoodTypes.MYQUESTE.getChestBoatItem());
        ...
        public ResourceLocation getTexture(boolean hasChest) {
            if (hasChest) {
                return HibernalHerbsMod.asResource("textures/entity/chest_boat/" + name + ".png");
            }
            return HibernalHerbsMod.asResource("textures/entity/boat/" + name + ".png");
        }
