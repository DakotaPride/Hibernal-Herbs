...
public class itemRegistry {
    ...
    public static final RegistryObject<Item> POUNDED_ROSEMARY = ITEMS.register("pounded_rosemary",
            () -> new Item(new Item.Properties().food(new FoodProperties.Builder()
                    .nutrition(4).saturationMod(3f).build()).tab(HibernalHerbsForge.POUNDED_HERBS)));
    ...
    public static final RegistryObject<Item> REGENERATIVE_BLEND = ITEMS.register("blend_regeneration",
            () -> new HerbBlendItem(new Item.Properties().food(new FoodProperties.Builder()
    ...
    public static final RegistryObject<Item> INCINERATING_BLEND = ITEMS.register("blend_fire",
            () -> new HerbBlendItem(new Item.Properties().food(new FoodProperties.Builder().nutrition(7).saturationMod(6).build()).tab(HibernalHerbsForge.HIBERNAL_HERBS)));
