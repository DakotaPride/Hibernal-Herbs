...
public class HerbalConjurationMenu extends AbstractContainerMenu {
    public final ConjurationAltarBlockEntity blockEntity;
    ...
    public HerbalConjurationMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 46, 23));
            this.addSlot(new SlotItemHandler(handler, 1, 68, 19));
            this.addSlot(new SlotItemHandler(handler, 2, 90, 23));
