...
public class MyquesteChestBoat extends MyquesteBoat implements HasCustomInventoryScreen, ContainerEntity {
    private NonNullList<ItemStack> itemStacks = NonNullList.withSize(27, ItemStack.EMPTY);
    @Nullable
    private ResourceLocation lootTable;
    private long lootTableSeed;

    public MyquesteChestBoat(EntityType<? extends MyquesteBoat> p_219869_, Level p_219870_) {
        super(p_219869_, p_219870_);
    }

    public MyquesteChestBoat(Level p_219872_, double p_219873_, double p_219874_, double p_219875_) {
        this(HibernalEntities.CHEST_BOAT.get(), p_219872_);
    ...
    public Item getDropItem() {
        return this.getMyquesteBoatType().chestBoatItem().get();
    }
