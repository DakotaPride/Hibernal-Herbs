...
public class MyquesteBoatEntity extends BoatEntity {
    ...
    public MyquesteBoatEntity(EntityType<? extends BoatEntity> pEntityType, World pLevel) {
        super(pEntityType, pLevel);
    }

    public MyquesteBoatEntity(World level, double x, double y, double z, String woodType) {
        this(EntityTypeRegistry.MYQUESTE_BOAT.get(), level);
        this.setPos(x, y, z);
        this.prevX = x;
        this.prevY = y;
        this.prevZ = z;
    ...
    @Override
    public Item asItem() {
        return ItemRegistry.MYQUESTE_BOAT;
    }
