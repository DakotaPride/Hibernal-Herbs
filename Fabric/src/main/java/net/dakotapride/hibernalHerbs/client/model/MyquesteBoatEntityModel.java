package net.dakotapride.hibernalHerbs.client.model;
...
public class MyquesteBoatEntityModel extends CompositeEntityModel<MyquesteBoatEntity> {
    ...
    public MyquesteBoatEntityModel(ModelPart root, boolean chest) {
    ...
    public void setAngles(MyquesteBoatEntity boatEntity, float f, float g, float h, float i, float j) {
    ...
    private static void setPaddleAngle(MyquesteBoatEntity entity, int sigma, ModelPart part, float angle) {
