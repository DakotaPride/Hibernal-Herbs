package net.dakotapride.hibernalherbs.fabric.block.entity;
...
import net.dakotapride.hibernalherbs.fabric.registry.BlockEntityRegistry;
    ...
    private static void craftItem(HerbConjurationAltarEntity entity) {
        ...
        if(hasRecipe(entity)) {
            if (!(entity.getStack(0).isIn(Utilities.SIGILS_ITEM_TAG))) {
                if (!entity.getStack(0).isOf(net.dakotapride.hibernalherbs.fabric.registry.ItemRegistry.SINGED_GRIMOIRE)) {
                    entity.removeStack(0, 1);
                }
            } else {
                entity.setStack(0, new ItemStack(ItemRegistry.CRACKED_SIGIL, 1));
            }
            if (!(entity.getStack(1).isIn(Utilities.SIGILS_ITEM_TAG))) {
                if (!entity.getStack(1).isOf(net.dakotapride.hibernalherbs.fabric.registry.ItemRegistry.SINGED_GRIMOIRE)) {
                    entity.removeStack(1, 1);
                }
            } else {
                entity.setStack(1, new ItemStack(ItemRegistry.CRACKED_SIGIL, 1));
            }
            if (!(entity.getStack(2).isIn(Utilities.SIGILS_ITEM_TAG))) {
                if (!entity.getStack(2).isOf(net.dakotapride.hibernalherbs.fabric.registry.ItemRegistry.SINGED_GRIMOIRE)) {
                    entity.removeStack(2, 1);
                }
            } else {
                entity.setStack(2, new ItemStack(ItemRegistry.CRACKED_SIGIL, 1));
            }
            if (!(entity.getStack(3).isIn(Utilities.SIGILS_ITEM_TAG))) {
                if (!entity.getStack(3).isOf(net.dakotapride.hibernalherbs.fabric.registry.ItemRegistry.SINGED_GRIMOIRE)) {
                    entity.removeStack(3, 1);
                }
            } else {
                entity.setStack(3, new ItemStack(ItemRegistry.CRACKED_SIGIL, 1));
            }
            if (!(entity.getStack(4).isIn(Utilities.SIGILS_ITEM_TAG))) {
                if (!entity.getStack(4).isOf(net.dakotapride.hibernalherbs.fabric.registry.ItemRegistry.SINGED_GRIMOIRE)) {
                    entity.removeStack(4, 1);
                }
            } else {
                entity.setStack(4, new ItemStack(ItemRegistry.CRACKED_SIGIL, 1));
            }
            if (!(entity.getStack(5).isIn(Utilities.SIGILS_ITEM_TAG))) {
                if (!entity.getStack(5).isOf(net.dakotapride.hibernalherbs.fabric.registry.ItemRegistry.SINGED_GRIMOIRE)) {
                    entity.removeStack(5, 1);
                }
            } else {
                entity.setStack(5, new ItemStack(ItemRegistry.CRACKED_SIGIL, 1));
            }
