    ...
    public static final ItemGroup HIBERNAL_HERBS_TAB = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().displayName(Text.translatable("itemGroup.hibernalherbs.hibernal_herbs"))
                    .icon(() -> new ItemStack(BlockInit.CONJURATION_ALTAR.asItem())).entries((displayContext, entries) -> {
                        ...
                        entries.add(ItemInit.REGENERATIVE_BLEND);
                        entries.add(ItemInit.SMOKED_REGENERATIVE_BLEND);
                        entries.add(ItemInit.VIRULENT_BLEND);
                        entries.add(ItemInit.SMOKED_VIRULENT_BLEND);
                        entries.add(ItemInit.SEDATING_BLEND);
                        entries.add(ItemInit.SMOKED_SEDATING_BLEND);
                        entries.add(ItemInit.HINDERING_BLEND);
                        entries.add(ItemInit.SMOKED_HINDERING_BLEND);
                        entries.add(ItemInit.DASHING_BLEND);
                        entries.add(ItemInit.SMOKED_DASHING_BLEND);
                        entries.add(ItemInit.ACCELERATION_BLEND);
                        entries.add(ItemInit.SMOKED_ACCELERATION_BLEND);
                        entries.add(ItemInit.INCINERATING_BLEND);
                        entries.add(ItemInit.SMOKED_INCINERATING_BLEND);
                        entries.add(ItemInit.DECAYING_BLEND);
                        entries.add(ItemInit.SMOKED_DECAYING_BLEND);
                        entries.add(ItemInit.OBSERVING_BLEND);
                        entries.add(ItemInit.SMOKED_OBSERVING_BLEND);
                        entries.add(ItemInit.DIMINISHED_BLEND);
                        entries.add(ItemInit.SMOKED_DIMINISHED_BLEND);
                        entries.add(ItemInit.SHADED_BLEND);
                        entries.add(ItemInit.SMOKED_SHADED_BLEND);
                        entries.add(ItemInit.CONFLICTING_BLEND);
                        entries.add(ItemInit.SMOKED_CONFLICTING_BLEND);
                        entries.add(ItemInit.ALTERNATIVE_BLEND);
                        entries.add(ItemInit.SMOKED_ALTERNATIVE_BLEND);
