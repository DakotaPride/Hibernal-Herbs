...
public class BlockInit {
    ...
    public static void init() {
        ...
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "rosemary"), new BlockItem(ROSEMARY, new FabricItemSettings().group(HibernalHerbsMod.groupManager.HERBS)));
        Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "thyme"), THYME);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "thyme"), new BlockItem(THYME, new FabricItemSettings().group(HibernalHerbsMod.groupManager.HERBS)));
        Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "tarragon"), TARRAGON);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "tarragon"), new BlockItem(TARRAGON, new FabricItemSettings().group(HibernalHerbsMod.groupManager.HERBS)));
        Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "chamomile"), CHAMOMILE);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "chamomile"), new BlockItem(CHAMOMILE, new FabricItemSettings().group(HibernalHerbsMod.groupManager.HERBS)));
        Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "chives"), CHIVES);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "chives"), new BlockItem(CHIVES, new FabricItemSettings().group(HibernalHerbsMod.groupManager.HERBS)));
        Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "verbena"), VERBENA);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "verbena"), new BlockItem(VERBENA, new FabricItemSettings().group(HibernalHerbsMod.groupManager.HERBS)));
        Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "sorrel"), SORREL);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "sorrel"), new BlockItem(SORREL, new FabricItemSettings().group(HibernalHerbsMod.groupManager.HERBS)));
        Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "marjoram"), MARJORAM);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "marjoram"), new BlockItem(MARJORAM, new FabricItemSettings().group(HibernalHerbsMod.groupManager.HERBS)));
        Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "chervil"), CHERVIL);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "chervil"), new BlockItem(CHERVIL, new FabricItemSettings().group(HibernalHerbsMod.groupManager.HERBS)));
        Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "fennsel"), FENNSEL);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "fennsel"), new BlockItem(FENNSEL, new FabricItemSettings().group(HibernalHerbsMod.groupManager.HERBS)));
        Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "ceillis"), CEILLIS);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "ceillis"), new BlockItem(CEILLIS, new FabricItemSettings().group(HibernalHerbsMod.groupManager.HERBS)));
        Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "punuel"), PUNUEL);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "punuel"), new BlockItem(PUNUEL, new FabricItemSettings().group(HibernalHerbsMod.groupManager.HERBS)));
        Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "essitte"), ESSITTE);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "essitte"), new BlockItem(ESSITTE, new FabricItemSettings().group(HibernalHerbsMod.groupManager.HERBS)));
        Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "thyocielle"), THYOCIELLE);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "thyocielle"), new BlockItem(THYOCIELLE, new FabricItemSettings().group(HibernalHerbsMod.groupManager.HERBS)));
