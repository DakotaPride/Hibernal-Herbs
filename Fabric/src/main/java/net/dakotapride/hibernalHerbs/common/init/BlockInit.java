...
public class BlockInit {
    ...
    // "Leaf" (Herb) Piles
    public static LeafPileBlock MYQUESTE_LEAF_PILE = new LeafPileBlock(FabricBlockSettings.of().sounds(BlockSoundGroup.GRASS).nonOpaque());

    public static LeafPileBlock ROSEMARY_HERB_PILE = new HibernalLeafPileBlock(FabricBlockSettings.of().sounds(BlockSoundGroup.GRASS).nonOpaque());
    public static LeafPileBlock THYME_HERB_PILE = new HibernalLeafPileBlock(FabricBlockSettings.of().sounds(BlockSoundGroup.GRASS).nonOpaque());
    public static LeafPileBlock TARRAGON_HERB_PILE = new HibernalLeafPileBlock(FabricBlockSettings.of().sounds(BlockSoundGroup.GRASS).nonOpaque());
    public static LeafPileBlock CHAMOMILE_HERB_PILE = new HibernalLeafPileBlock(FabricBlockSettings.of().sounds(BlockSoundGroup.GRASS).nonOpaque());
    public static LeafPileBlock CHIVES_HERB_PILE = new HibernalLeafPileBlock(FabricBlockSettings.of().sounds(BlockSoundGroup.GRASS).nonOpaque());
    public static LeafPileBlock VERBENA_HERB_PILE = new HibernalLeafPileBlock(FabricBlockSettings.of().sounds(BlockSoundGroup.GRASS).nonOpaque());
    public static LeafPileBlock SORREL_HERB_PILE = new HibernalLeafPileBlock(FabricBlockSettings.of().sounds(BlockSoundGroup.GRASS).nonOpaque());
    public static LeafPileBlock MARJORAM_HERB_PILE = new HibernalLeafPileBlock(FabricBlockSettings.of().sounds(BlockSoundGroup.GRASS).nonOpaque());
    public static LeafPileBlock CHERVIL_HERB_PILE = new HibernalLeafPileBlock(FabricBlockSettings.of().sounds(BlockSoundGroup.GRASS).nonOpaque());
    public static LeafPileBlock FENNSEL_HERB_PILE = new HibernalLeafPileBlock(FabricBlockSettings.of().sounds(BlockSoundGroup.GRASS).nonOpaque());
    public static LeafPileBlock CEILLIS_HERB_PILE = new HibernalLeafPileBlock(FabricBlockSettings.of().sounds(BlockSoundGroup.GRASS).nonOpaque());
    public static LeafPileBlock PUNUEL_HERB_PILE = new HibernalLeafPileBlock(FabricBlockSettings.of().sounds(BlockSoundGroup.GRASS).nonOpaque());
    public static LeafPileBlock ESSITTE_HERB_PILE = new HibernalLeafPileBlock(FabricBlockSettings.of().sounds(BlockSoundGroup.GRASS).nonOpaque());

    public static LeafPileBlock THYOCIELLE_HERB_PILE = new HibernalLeafPileBlock(FabricBlockSettings.of().sounds(BlockSoundGroup.GRASS).nonOpaque());
    public static LeafPileBlock FENNKYSTRAL_HERB_PILE = new HibernalLeafPileBlock(FabricBlockSettings.of().sounds(BlockSoundGroup.GRASS).nonOpaque());

    public static LeafPileBlock CALENDULA_HERB_PILE = new HibernalLeafPileBlock(FabricBlockSettings.of().sounds(BlockSoundGroup.GRASS).nonOpaque());
    ...
    public static DoorBlock MYQUESTE_DOOR = new DoorBlock(FabricBlockSettings.copy(Blocks.SPRUCE_DOOR), BlockSetType.SPRUCE);
    public static TrapdoorBlock MYQUESTE_TRAPDOOR = new TrapdoorBlock(FabricBlockSettings.copy(Blocks.SPRUCE_TRAPDOOR), TypeInit.SetType.MYQUESTE);
    ...
    public static FenceGateBlock MYQUESTE_FENCE_GATE = new FenceGateBlock(FabricBlockSettings.copy(Blocks.SPRUCE_FENCE_GATE), TypeInit.WoodType.MYQUESTE);
    ...
    public static ButtonBlock MYQUESTE_BUTTON = new ButtonBlock(FabricBlockSettings.copy(Blocks.SPRUCE_BUTTON), TypeInit.SetType.MYQUESTE, 30, true);
    ...
    public static void init() {
        ...
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "rosemary"), new BlockItem(ROSEMARY, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "thyme"), THYME);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "thyme"), new BlockItem(THYME, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "tarragon"), TARRAGON);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "tarragon"), new BlockItem(TARRAGON, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "chamomile"), CHAMOMILE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "chamomile"), new BlockItem(CHAMOMILE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "chives"), CHIVES);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "chives"), new BlockItem(CHIVES, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "verbena"), VERBENA);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "verbena"), new BlockItem(VERBENA, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "sorrel"), SORREL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "sorrel"), new BlockItem(SORREL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "marjoram"), MARJORAM);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "marjoram"), new BlockItem(MARJORAM, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "chervil"), CHERVIL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "chervil"), new BlockItem(CHERVIL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "fennsel"), FENNSEL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "fennsel"), new BlockItem(FENNSEL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "ceillis"), CEILLIS);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "ceillis"), new BlockItem(CEILLIS, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "punuel"), PUNUEL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "punuel"), new BlockItem(PUNUEL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "essitte"), ESSITTE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "essitte"), new BlockItem(ESSITTE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "thyocielle"), THYOCIELLE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "thyocielle"), new BlockItem(THYOCIELLE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "fennkystral"), FENNKYSTRAL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "fennkystral"), new BlockItem(FENNKYSTRAL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "calendula"), CALENDULA);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "calendula"), new BlockItem(CALENDULA, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "sage"), SAGE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "sage"), new BlockItem(SAGE, new FabricItemSettings()));

        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "pride_herb"), PRIDE_HERB);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "pride_herb"), new BlockItem(PRIDE_HERB, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "envy_herb"), ENVY_HERB);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "envy_herb"), new BlockItem(ENVY_HERB, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "wrath_herb"), WRATH_HERB);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "wrath_herb"), new BlockItem(WRATH_HERB, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "greed_herb"), GREED_HERB);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "greed_herb"), new BlockItem(GREED_HERB, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "gluttony_herb"), GLUTTONY_HERB);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "gluttony_herb"), new BlockItem(GLUTTONY_HERB, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "sloth_herb"), SLOTH_HERB);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "sloth_herb"), new BlockItem(SLOTH_HERB, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "lust_herb"), LUST_HERB);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "lust_herb"), new BlockItem(LUST_HERB, new FabricItemSettings()));
        ...
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "myqueste_sapling"), new BlockItem(MYQUESTE_SAPLING, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "myqueste_log"), MYQUESTE_LOG);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "myqueste_log"), new BlockItem(MYQUESTE_LOG, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "myqueste_leaves"), MYQUESTE_LEAVES);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "myqueste_leaves"), new BlockItem(MYQUESTE_LEAVES, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "stripped_myqueste_log"), STRIPPED_MYQUESTE_LOG);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "stripped_myqueste_log"), new BlockItem(STRIPPED_MYQUESTE_LOG, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "myqueste_wood"), MYQUESTE_WOOD);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "myqueste_wood"), new BlockItem(MYQUESTE_WOOD, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "stripped_myqueste_wood"), STRIPPED_MYQUESTE_WOOD);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "stripped_myqueste_wood"), new BlockItem(STRIPPED_MYQUESTE_WOOD, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "myqueste_planks"), MYQUESTE_PLANKS);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "myqueste_planks"), new BlockItem(MYQUESTE_PLANKS, new FabricItemSettings()));

        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "myqueste_stairs"), MYQUESTE_STAIRS);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "myqueste_stairs"), new BlockItem(MYQUESTE_STAIRS, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "myqueste_slab"), MYQUESTE_SLAB);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "myqueste_slab"), new BlockItem(MYQUESTE_SLAB, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "myqueste_door"), MYQUESTE_DOOR);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "myqueste_door"), new BlockItem(MYQUESTE_DOOR, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "myqueste_trapdoor"), MYQUESTE_TRAPDOOR);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "myqueste_trapdoor"), new BlockItem(MYQUESTE_TRAPDOOR, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "myqueste_fence"), MYQUESTE_FENCE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "myqueste_fence"), new BlockItem(MYQUESTE_FENCE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "myqueste_fence_gate"), MYQUESTE_FENCE_GATE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "myqueste_fence_gate"), new BlockItem(MYQUESTE_FENCE_GATE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "myqueste_button"), MYQUESTE_BUTTON);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "myqueste_button"), new BlockItem(MYQUESTE_BUTTON, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "myqueste_pressure_plate"), MYQUESTE_PRESSURE_PLATE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "myqueste_pressure_plate"), new BlockItem(MYQUESTE_PRESSURE_PLATE, new FabricItemSettings()));
        ...
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "rosemary_herb_pile"), new BlockItem(ROSEMARY_HERB_PILE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "thyme_herb_pile"), THYME_HERB_PILE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "thyme_herb_pile"), new BlockItem(THYME_HERB_PILE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "tarragon_herb_pile"), TARRAGON_HERB_PILE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "tarragon_herb_pile"), new BlockItem(TARRAGON_HERB_PILE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "chamomile_herb_pile"), CHAMOMILE_HERB_PILE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "chamomile_herb_pile"), new BlockItem(CHAMOMILE_HERB_PILE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "chives_herb_pile"), CHIVES_HERB_PILE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "chives_herb_pile"), new BlockItem(CHIVES_HERB_PILE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "verbena_herb_pile"), VERBENA_HERB_PILE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "verbena_herb_pile"), new BlockItem(VERBENA_HERB_PILE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "sorrel_herb_pile"), SORREL_HERB_PILE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "sorrel_herb_pile"), new BlockItem(SORREL_HERB_PILE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "marjoram_herb_pile"), MARJORAM_HERB_PILE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "marjoram_herb_pile"), new BlockItem(MARJORAM_HERB_PILE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "chervil_herb_pile"), CHERVIL_HERB_PILE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "chervil_herb_pile"), new BlockItem(CHERVIL_HERB_PILE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "fennsel_herb_pile"), FENNSEL_HERB_PILE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "fennsel_herb_pile"), new BlockItem(FENNSEL_HERB_PILE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "ceillis_herb_pile"), CEILLIS_HERB_PILE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "ceillis_herb_pile"), new BlockItem(CEILLIS_HERB_PILE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "punuel_herb_pile"), PUNUEL_HERB_PILE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "punuel_herb_pile"), new BlockItem(PUNUEL_HERB_PILE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "essitte_herb_pile"), ESSITTE_HERB_PILE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "essitte_herb_pile"), new BlockItem(ESSITTE_HERB_PILE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "thyocielle_herb_pile"), THYOCIELLE_HERB_PILE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "thyocielle_herb_pile"), new BlockItem(THYOCIELLE_HERB_PILE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "fennkystral_herb_pile"), FENNKYSTRAL_HERB_PILE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "fennkystral_herb_pile"), new BlockItem(FENNKYSTRAL_HERB_PILE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "calendula_herb_pile"), CALENDULA_HERB_PILE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "calendula_herb_pile"), new BlockItem(CALENDULA_HERB_PILE, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "sage_herb_pile"), SAGE_HERB_PILE);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "sage_herb_pile"), new BlockItem(SAGE_HERB_PILE, new FabricItemSettings()));

        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "rosemary_herb_barrel"), ROSEMARY_HERB_BARREL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "rosemary_herb_barrel"), new BlockItem(ROSEMARY_HERB_BARREL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "thyme_herb_barrel"), THYME_HERB_BARREL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "thyme_herb_barrel"), new BlockItem(THYME_HERB_BARREL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "tarragon_herb_barrel"), TARRAGON_HERB_BARREL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "tarragon_herb_barrel"), new BlockItem(TARRAGON_HERB_BARREL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "chamomile_herb_barrel"), CHAMOMILE_HERB_BARREL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "chamomile_herb_barrel"), new BlockItem(CHAMOMILE_HERB_BARREL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "chives_herb_barrel"), CHIVES_HERB_BARREL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "chives_herb_barrel"), new BlockItem(CHIVES_HERB_BARREL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "verbena_herb_barrel"), VERBENA_HERB_BARREL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "verbena_herb_barrel"), new BlockItem(VERBENA_HERB_BARREL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "sorrel_herb_barrel"), SORREL_HERB_BARREL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "sorrel_herb_barrel"), new BlockItem(SORREL_HERB_BARREL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "marjoram_herb_barrel"), MARJORAM_HERB_BARREL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "marjoram_herb_barrel"), new BlockItem(MARJORAM_HERB_BARREL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "chervil_herb_barrel"), CHERVIL_HERB_BARREL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "chervil_herb_barrel"), new BlockItem(CHERVIL_HERB_BARREL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "fennsel_herb_barrel"), FENNSEL_HERB_BARREL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "fennsel_herb_barrel"), new BlockItem(FENNSEL_HERB_BARREL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "ceillis_herb_barrel"), CEILLIS_HERB_BARREL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "ceillis_herb_barrel"), new BlockItem(CEILLIS_HERB_BARREL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "punuel_herb_barrel"), PUNUEL_HERB_BARREL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "punuel_herb_barrel"), new BlockItem(PUNUEL_HERB_BARREL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "essitte_herb_barrel"), ESSITTE_HERB_BARREL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "essitte_herb_barrel"), new BlockItem(ESSITTE_HERB_BARREL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "thyocielle_herb_barrel"), THYOCIELLE_HERB_BARREL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "thyocielle_herb_barrel"), new BlockItem(THYOCIELLE_HERB_BARREL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "fennkystral_herb_barrel"), FENNKYSTRAL_HERB_BARREL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "fennkystral_herb_barrel"), new BlockItem(FENNKYSTRAL_HERB_BARREL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "calendula_herb_barrel"), CALENDULA_HERB_BARREL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "calendula_herb_barrel"), new BlockItem(CALENDULA_HERB_BARREL, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "sage_herb_barrel"), SAGE_HERB_BARREL);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "sage_herb_barrel"), new BlockItem(SAGE_HERB_BARREL, new FabricItemSettings()));

        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "calendula_lantern"), CALENDULA_LANTERN);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "calendula_lantern"), new BlockItem(CALENDULA_LANTERN, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "rosemary_lantern"), ROSEMARY_LANTERN);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "rosemary_lantern"), new BlockItem(ROSEMARY_LANTERN, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "thyme_lantern"), THYME_LANTERN);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "thyme_lantern"), new BlockItem(THYME_LANTERN, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "tarragon_lantern"), TARRAGON_LANTERN);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "tarragon_lantern"), new BlockItem(TARRAGON_LANTERN, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "chamomile_lantern"), CHAMOMILE_LANTERN);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "chamomile_lantern"), new BlockItem(CHAMOMILE_LANTERN, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "chives_lantern"), CHIVES_LANTERN);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "chives_lantern"), new BlockItem(CHIVES_LANTERN, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "verbena_lantern"), VERBENA_LANTERN);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "verbena_lantern"), new BlockItem(VERBENA_LANTERN, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "sorrel_lantern"), SORREL_LANTERN);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "sorrel_lantern"), new BlockItem(SORREL_LANTERN, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "marjoram_lantern"), MARJORAM_LANTERN);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "marjoram_lantern"), new BlockItem(MARJORAM_LANTERN, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "chervil_lantern"), CHERVIL_LANTERN);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "chervil_lantern"), new BlockItem(CHERVIL_LANTERN, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "fennsel_lantern"), FENNSEL_LANTERN);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "fennsel_lantern"), new BlockItem(FENNSEL_LANTERN, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "ceillis_lantern"), CEILLIS_LANTERN);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "ceillis_lantern"), new BlockItem(CEILLIS_LANTERN, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "punuel_lantern"), PUNUEL_LANTERN);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "punuel_lantern"), new BlockItem(PUNUEL_LANTERN, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "essitte_lantern"), ESSITTE_LANTERN);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "essitte_lantern"), new BlockItem(ESSITTE_LANTERN, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "thyocielle_lantern"), THYOCIELLE_LANTERN);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "thyocielle_lantern"), new BlockItem(THYOCIELLE_LANTERN, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "fennkystral_lantern"), FENNKYSTRAL_LANTERN);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "fennkystral_lantern"), new BlockItem(FENNKYSTRAL_LANTERN, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "sage_lantern"), SAGE_LANTERN);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "sage_lantern"), new BlockItem(SAGE_LANTERN, new FabricItemSettings()));

        Registry.register(Registries.BLOCK, new Identifier(MOD_ID, "conjuration_altar"), CONJURATION_ALTAR);
        Registry.register(Registries.ITEM, new Identifier(MOD_ID, "conjuration_altar"), new BlockItem(CONJURATION_ALTAR, new FabricItemSettings()));
    }
